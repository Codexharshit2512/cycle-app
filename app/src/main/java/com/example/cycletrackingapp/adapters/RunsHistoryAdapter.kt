...
class RunsHistoryAdapter(private val context:Context,private var list:List<Run>?,private val listener:  RunClickListener)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        list?.apply {
            ...
            holder.binding.apply {
                ...
                runTime.text = DateTimeUtil.extractTime(data.time)
                root.setOnClickListener(object:View.OnClickListener{
                    override fun onClick(p0: View?) {
                        listener.onRecordClick(data)
                    }
                })
            }
        }
